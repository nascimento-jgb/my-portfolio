			...
			<div className="container mx-auto">
				<div className="flex flex-col lg:flex-row justify-between items-center mt-12">
					<div className="text-center lg:text-left mb-6 lg:mb-0">
						<h2 className="text-8xl max-w-3xl font-medium font-sans-serif font-GraphikSemiBold mt-14 ml-6">
							Let's connect digitally
						</h2>
						<p className="mt-16 text-xl font-semibold font-sans-serif font-GraphikSemiBold ml-6">
							&copy; 2023 João Nascimento
						</p>
					</div>
					<div className="mt-16 flex flex-col space-y-4 mr-6">
						<button
							className={`${
