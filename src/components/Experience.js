...
// 			2022 - present
// 		</div>
// 		<div className="text-white font-semibold font-sans-serif font-GilroyBold leading-relaxed tracking-wide p-4"
// 			style={{ fontSize: "20px", zIndex: 20, paddingLeft: "15%", p }}>
// 			Project base and peer-to-peer learning:
	...
	return (
		<div className="bg-black relative overflow-hidden pt-10">
			...
			<div className="p-32">
				...
				<div className="flex flex-col md:flex-row w-full text-white font-semibold font-sans-serif font-GilroyBold leading-relaxed tracking-wide p-4"
			...
			<div className='w-96 mx-auto mr-20 pt-[-10] pb-32'>
					<Link
					 to="https://www.linkedin.com/in/joaog-nascimento/"
					 target="_blank"
					 className="bg-gray-500 text-white py-4 px-8 font-semibold font-GilroyLight font-sans-serif hover:bg-gray-600 transition mt-8 mb-24 ">
